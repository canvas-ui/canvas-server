...
**Config:** `CANVAS_CLIP_MODEL` (default Xenova/siglip-base-patch16-224), `CANVAS_CLIP_DTYPE` (fp32 default; q8 = 2-4x faster), `CANVAS_EMBED_THREADS` (explicit intraOpNumThreads - disables the affinity pinning that fails under cgroup limits).
